...
class PACOCascadeROIHeads(PACOROIHeads):
    """
    The ROI heads that implement :paper:`Cascade R-CNN`.
    This is borrowed from D2 implementation. The only change is that this
    inherits from PACOROIHeads and supports forward pass with attributes head
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        Args:
            box_pooler (ROIPooler): pooler that extracts region features from
                given boxes
        ...
        # The first matcher matches RPN proposals with ground truth, done in
        # the base class
    ...
    def _match_and_label_boxes(self, proposals, stage, targets):
        ...
        Returns:
            list[Instances]: the same proposals, but with fields "gt_classes"
            and "gt_boxes"
        """
    ...
    def _run_stage(self, features, proposals, stage):
        ...
        Args:
            ...
            proposals (list[Instances]): #image Instances, with the field
                "proposal_boxes"
            stage (int): the current stage
